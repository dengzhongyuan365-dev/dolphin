...
void MediaWidget::onPlaybackStateChanged(QMediaPlayer::PlaybackState newState)
{
...
void MediaWidget::initPlayer()
{
    if (!m_player) {
        ...
        connect(m_player, &QMediaPlayer::playbackStateChanged, this, &MediaWidget::onPlaybackStateChanged);
